    ...
    <>
      ...
      <div className="main">
        ...
        <div className={'main__layout'}>
          ...
          <PrivateRoute exact path={paths.ALBUM}><AlbumLayout/></PrivateRoute>
          <PrivateRoute exact path={paths.PLAYLIST}><PlaylistLayout/></PrivateRoute>
          <PrivateRoute exact path={paths.PROFILE}><ProfileLayout/></PrivateRoute>
        </div>
